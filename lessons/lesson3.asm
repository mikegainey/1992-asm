...
; Mod. dates   : 2/5/92 (error trapping)
;
;   Description  :
; Convert a decimal digit, input by the user, to binary and display
;
;   New operations:
...
;******************************************************************************
data    segment
digit_mess      db      'Type one decimal digit: $'
...
getkey:
        ...
        int     16H             ;goto BIOS
        cmp     al,30H          ;30H is ascii '0'
        jb      getkey          ;invalid input, try again
        cmp     al,39H          ;39H is ascii '9'
        ja      getkey          ;invalid input, try again
;
; Convert to binary
